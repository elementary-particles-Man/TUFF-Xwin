...
impl WireFakeClient {
    ...
    pub fn zxdg_output_manager_get_xdg_output(
        &mut self,
        manager_id: u32,
        new_id: u32,
        output_id: u32,
    ...
    pub fn zwlr_output_manager_create_configuration(
        &mut self,
        manager_id: u32,
        new_id: u32,
        serial: u32,
    ...
    pub fn zwlr_screencopy_capture_output(
        &mut self,
        manager_id: u32,
        new_id: u32,
        overlay: u32,
    ...
    pub fn ext_image_copy_capture_create_session(
        &mut self,
        manager_id: u32,
        new_id: u32,
        source_type: u32,
    ...
    pub fn ext_image_copy_capture_create_frame(
        &mut self,
        session_id: u32,
        new_id: u32,
    ) -> Result<()> {
    ...
    pub fn ext_image_copy_capture_frame_copy(
        &mut self,
        frame_id: u32,
        buffer_id: u32,
    ) -> Result<()> {
