...
## 移行済みプロファイル
- `demo-x11`: compd -> demo-wm, x11bridge -> demo-x11bridge, lockd -> demo-lockui
- `demo-x11-crashy`: compd -> crashy-wm, lockd -> demo-lockui
- `demo-x11-degraded`: compd -> demo-fallback-wm, x11bridge -> demo-x11bridge-fallback, lockd -> demo-lockui-fallback
...
- (Lockd を含めた全コンポーネントの明示的バインディング化は完了済み)
